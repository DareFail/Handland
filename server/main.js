...
app.get('/apple-touch-icon.png', (req, res) => {
  res.sendFile(path.join(__dirname,'../icons/apple-touch-icon.png'));
});

app.get('/favicon-32x32.png', (req, res) => {
  res.sendFile(path.join(__dirname,'../icons/favicon-32x32.png'));
});
...
app.get('/site.webmanifest', (req, res) => {
  res.sendFile(path.join(__dirname,'../icons/site.webmanifest'));
});

app.get('/safari-pinned-tab.svg', (req, res) => {
  res.sendFile(path.join(__dirname,'../icons/safari-pinned-tab.svg'));
});
